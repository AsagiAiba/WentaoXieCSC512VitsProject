...
from monotonic_align import monotonic_run
from text import text_to_sequence
from text.symbols import symbols
import sys, shutil
from PyQt5.QtWidgets import QApplication, QMainWindow, QTextEdit, QPushButton, QVBoxLayout, QWidget, QFileDialog, QProgressBar
...
class SynthesizerTrn(nn.Module):
    ...
    def forward(self, x, x_lengths, y, y_lengths, sid=None):
        ...
        with torch.no_grad():
            ...
            attn = monotonic_run.maximum_path(neg_cent, attn_mask.squeeze(1)).unsqueeze(1).detach()
...
class MainWindow(QMainWindow):
    ...
    def play(self):
        ...
        if text:
            ...
            content = QMediaContent(QUrl.fromLocalFile("/Users/aibaasagi/Desktop/vits/pre.wav"))
